        ...
        <>
            <div className="w-full bg-[#111827] pt-10 pb-10 ff-roboto">
                <div className="flex flex-col md:flex-row justify-between items-start">
                    <div className="w-80 md:w-2/5 m-3 md:m-5">
                        <img src="/footer_logo.png" alt="logo" className="h-16 object-contain" />
                    ...
                    <div className="w-80 md:w-1/5 text-white space-y-1 m-3 md:m-5">
                    ...
                    <div className="w-80 md:w-1/5 text-white m-3 md:m-5 flex flex-col">
